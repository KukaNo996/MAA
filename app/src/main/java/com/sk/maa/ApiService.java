...
public interface ApiService {
    ...
    @POST("schedule/reservation/{siteId}/{timeIds}")
    Call<ResponseBody> submitData(@HeaderMap Map<String, String> headers,
                                              @Path("siteId") Integer siteId,
                                                @Path("timeIds")String timeIds);
}
